## 프로젝트 개요
이 프로젝트는 게시판 시스템을 위한 기본 템플릿입니다. React와 JSON Server를 사용하여 구현된 풀스택 애플리케이션입니다.
## 프로젝트 구조
...
│   └── web/          # React 19 + Vite 기반 프론트엔드 애플리케이션
